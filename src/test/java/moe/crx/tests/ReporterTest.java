...
public final class ReporterTest extends GuicedTest {
    ...
    void getProductsInfoInPeriod() throws ParseException {
        ...
        second.put(new Product(3, "Ximi Reimu 11T"), new ProductSummary(1000, 19999000));
        var third = new HashMap<Product, ProductSummary>();
        third.put(new Product(4, "Gnusmas Space C22"), new ProductSummary(250, 16925000));
        info.getPerDay().put(new Date(formatter.parse("2022-01-01").getTime()), first);
        info.getPerDay().put(new Date(formatter.parse("2022-01-05").getTime()), second);
        info.getPerDay().put(new Date(formatter.parse("2022-01-02").getTime()), third);
    ...
    void getSuppliedProductsInPeriod() throws ParseException {
        ...
        supplied.put(new Organization(111111, "N.Video Store", "614615097140"), Arrays.asList(new Product(2, "ePhone 14 Super Puper"), new Product(4, "Gnusmas Space C22")));
